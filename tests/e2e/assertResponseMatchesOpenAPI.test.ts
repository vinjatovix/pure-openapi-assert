...
describe('assertResponseMatchesOpenAPI', () => {
  describe('Exhaustive Validation Specs (mock-openapi.yaml)', () => {
    ...
    describe('Track 3.2: Content-Type Validation and Deprecations', () => {
      ...
      describe('Header Validation (/test/headers)', () => {
        ...
        it('should validate headers defined using content', async () => {
          await expect(
            ...
            '[headers.X-JSON-Header.foo] Missing required field'
          );
        ...
        it('should automatically infer Content-Type from headers when contentType is omitted', async () => {
          await expect(
            assertResponseMatchesOpenAPI({
              specPath,
              path: '/test/content-type/xml',
        ...
        describe('Robustness and DX Defensive Handling', () => {
          ...
          it('should defensively infer content-type from an array content-type header', async () => {
            await expect(
              assertResponseMatchesOpenAPI({
                specPath,
                path: '/test/content-type/xml',
